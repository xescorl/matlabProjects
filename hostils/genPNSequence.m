...
%es pot buscar per internet, es posa pels coeficients. si es un X ha de
%tindre longitud X
%utilitzarem les sequencies pm per a mesurar el canal
%x ex:
%pn = genPNSequence([6 1 0], [0 0 0 0 0 1]);
% com hi ha un 6, hem posat 6 nums (?)
N=2^polynomial(1)-1;
